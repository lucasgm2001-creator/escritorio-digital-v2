...
export default async function HallPage() {
  ...
  // Atividades (Visão Geral) + tarefas/leads/clients (aba Tarefas) + profile — em paralelo.
  const [{ data: activities }, tasksRes, leadsRes, clientsRes, profile] = await Promise.all([
